...
for _, row in tables_df.iterrows():
    ...
    log_entries.append((table_name, schema_name, source, workspace_id, optimize_status, "OPTIMIZE", float(optimize_duration), get_current_timestamp()))
    if vacuum_status in ["Success", "Failure"]:
        log_entries.append((table_name, schema_name, source, workspace_id, vacuum_status, "VACUUM", float(vacuum_duration), get_current_timestamp()))
