-- Auto Generated (Do not modify) 5E394E40437F698C3E6AAFD58FDD6BA83027F4AD5AC2729582C63ECBB02A6075
create view "mim"."bv_industry" as -- ===============================
...
WITH source_industry AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_industry" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_industry" sat ON hub.bkey_industry_source = sat.bkey_industry_source
