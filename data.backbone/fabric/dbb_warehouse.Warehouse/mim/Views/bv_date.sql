-- Auto Generated (Do not modify) 03DE44D4F19970B18A2B44A5ED72F411A97649663BE301824F65258404BD2C91
create view "mim"."bv_date" as WITH source_date AS (
    SELECT
        hub.bkey_date,
        hub.bkey_source,
        sat.date_key,
        ...
        sat.day_name_short,
        sat.day_name_long
    FROM "dbb_warehouse"."mim"."rv_hub_date" AS hub 
    INNER JOIN "dbb_warehouse"."mim"."rv_sat_date" AS sat ON hub.bkey_date_source = sat.bkey_date_source
)
