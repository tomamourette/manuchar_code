-- Auto Generated (Do not modify) 86E65F76C466C29BB76FF8A700B8EB726A3D75740D93494C98BAE91726F664FB
create view "mim"."bv_customer" as -- ===============================
...
WITH source_customer AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_customer" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_customer" sat ON hub.bkey_customer_source = sat.bkey_customer_source
