-- Auto Generated (Do not modify) 79131A6911895B6CC524E0D9BBF9D5CE056643011B5C78CE0BED91A23022BA9B
...
onprem_invoices_per_snapshot AS (
    SELECT  
        ...
        CASE 
            WHEN inv.sales_invoice_local_currency_code = 'XOF' THEN 'CFA'
            WHEN inv.sales_invoice_local_currency_code = 'RMB' THEN 'CNY'
            ELSE inv.sales_invoice_local_currency_code
...
dynamics_invoices_per_snapshot AS (
    SELECT
        ...
        MAX(inv.sales_invoice_local_currency_code) AS bkey_currency,
        MAX(
            COALESCE(
