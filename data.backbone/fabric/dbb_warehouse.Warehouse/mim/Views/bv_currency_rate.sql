-- Auto Generated (Do not modify) 6A4C423D297F953F0CFA585094CE3DFDA6D3BAE4782B7C984C3BBD71D6C9D2E8
create view "mim"."bv_currency_rate" as -- ===============================
...
WITH source_currency_rate AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_currency_rate" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_currency_rate" sat ON hub.bkey_currency_rate_source = sat.bkey_currency_rate_source
