-- Auto Generated (Do not modify) A8425F1D26FCFA8FB31FE1E631479AD5BF3559DB463216B378E4112C66B84E94
create view "mim"."bv_location" as -- ===============================
...
WITH source_location AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_location" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_location" sat ON hub.bkey_location_source = sat.bkey_location_source
