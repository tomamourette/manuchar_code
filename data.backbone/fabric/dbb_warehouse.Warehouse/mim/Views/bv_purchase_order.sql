-- Auto Generated (Do not modify) DC1DDC03D4FB9833C595BCF4346832F8FB30F3E75E86EB4759D9D43B0DCE61EE
create view "mim"."bv_purchase_order" as WITH purchase_order AS (
    SELECT
        ...
        sat.valid_to,
        sat.is_current
    FROM "dbb_warehouse"."mim"."rv_hub_purchase_order" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_purchase_order" sat ON hub.bkey_purchase_order_source = sat.bkey_purchase_order_source
