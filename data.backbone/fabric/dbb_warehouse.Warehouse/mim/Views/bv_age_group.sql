-- Auto Generated (Do not modify) 6EFDFFFDAC471F881B8675F70194704A2A2B6A71B306DA7499E3453B26F50223
create view "mim"."bv_age_group" as -- ===============================
...
WITH source_age_group AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_age_group" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_age_group" sat ON hub.bkey_age_group_source = sat.bkey_age_group_source
