-- Auto Generated (Do not modify) 494D8D449ABDB11F4E1E1F84581A8A8257F12E47599FC9E9808154BEF31A323C
create view "mim"."bv_supplier" as -- ===============================
...
WITH source_supplier AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_supplier" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_supplier" sat ON hub.bkey_supplier_source = sat.bkey_supplier_source
