-- Auto Generated (Do not modify) D3E24DD153530AED42B6E174F678E8C5C4AD7A46CA17C82DE5589C9CC9D28989
create view "mim"."bv_business_unit" as -- ===============================
...
WITH source_business_unit AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_business_unit" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_business_unit" sat ON hub.bkey_business_unit_source = sat.bkey_business_unit_source
