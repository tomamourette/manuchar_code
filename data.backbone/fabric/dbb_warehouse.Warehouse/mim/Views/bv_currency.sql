-- Auto Generated (Do not modify) CAAE89B4B19BBF0FBA6B82A54FB08869C5671B3AABEB14B8852F224165A632DB
create view "mim"."bv_currency" as WITH source_currency AS (
    SELECT
        hub.bkey_currency,
        hub.bkey_source,
        sat.currency_name,
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_currency" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_currency" sat ON hub.bkey_currency_source = sat.bkey_currency_source
