-- Auto Generated (Do not modify) 0E911AFD10CFF5C4B3F52728EC448587A9D1274A0E2DAC1FEE6B2CFC67139298
create view "mim"."bv_vessel" as -- ===============================
...
WITH source_vessel AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_vessel" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_vessel" sat ON hub.bkey_vessel_source = sat.bkey_vessel_source
