-- Auto Generated (Do not modify) 05BF5F525AD6FC86FFBAADC7E78780765D5E4F5E476E62A3E4C8A6CB2E2E4249
create view "mim"."bv_product_global" as -- ===============================
...
WITH source_product AS (
    SELECT
        ...
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_product_global" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_product_global" sat ON hub.bkey_product_global_source = sat.bkey_product_global_source
