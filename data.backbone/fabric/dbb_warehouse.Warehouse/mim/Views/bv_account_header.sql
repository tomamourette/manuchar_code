-- Auto Generated (Do not modify) 600EA76D5D5F8E01F9A9D708ACB3BADCE49D24E0AE27B813C72889AF5007CC64
create view "mim"."bv_account_header" as -- ===============================
...
WITH source_account_header AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM "dbb_warehouse"."mim"."rv_hub_account_header" hub
    LEFT JOIN "dbb_warehouse"."mim"."rv_sat_account_header" sat ON hub.bkey_account_header_source = sat.bkey_account_header_source
