WITH source_purchase_invoice_line_dynamics AS ( 
    SELECT 
...
sources_combined AS (
    SELECT 
        ...
        ldts,
        record_source
    FROM source_purchase_invoice_line_dynamics
),
...
sources_deduplicated AS (
    SELECT 
        ...
        ldts,
        record_source,
        ROW_NUMBER() OVER (PARTITION BY bkey_purchase_invoice_line_source ORDER BY ldts ASC) AS row_number
