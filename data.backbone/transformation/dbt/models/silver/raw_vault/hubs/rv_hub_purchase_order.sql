WITH source_purchase_order_dynamics AS ( 
    SELECT 
...
sources_combined AS (
    SELECT 
        ...
        ldts,
        record_source
    FROM source_purchase_order_dynamics
),
...
sources_deduplicated AS (
    SELECT 
        ...
        ldts,
        record_source,
        ROW_NUMBER() OVER (PARTITION BY bkey_purchase_order_source ORDER BY ldts ASC) AS row_number
