...
WITH source_consolidation_period AS (
    SELECT
        ...
        sat.valid_from,
        sat.valid_to
    FROM {{ ref('rv_hub_consolidation_period')}} hub
    LEFT JOIN {{ ref('rv_sat_consolidation_period')}} sat ON hub.bkey_consolidation_period_source = sat.bkey_consolidation_period_source
