...
WITH mds_customer_industry_invoice_history AS (
    ...
    SELECT
	    Code + '_MDS' AS bkey_customer_industry_invoice_source,
        Code AS bkey_customer_industry_invoice,
        'MDS' AS bkey_source,
        Name,
        [Group],
...
SELECT 
    ...
    e1.Name AS customer_industry_invoice_name,
    e1.[Group] AS customer_industry_invoice_group,
