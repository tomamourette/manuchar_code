...
CREATE PROCEDURE [21D365_ods].[usp_Insertdimensionattributevalueset]
...
BEGIN
	...
	*/
	...
	UPDATE A
	  ...
	  FROM [21D365_stg].[dimensionattributevalueset] A; 
	...
	*/
	...
	IF NOT EXISTS (SELECT count(*) FROM [21D365_ods].[dimensionattributevalueset] HAVING count(*) > 0)
	BEGIN
	    UPDATE [21D365_stg].[dimensionattributevalueset]
	...
	*/
	...
	IF EXISTS (SELECT count(*) FROM [21D365_ods].[dimensionattributevalueset] HAVING count(*) > 0)
	BEGIN

		UPDATE A
		   SET A.[ODSRecordStatus] = 'N'
		  FROM [21D365_stg].[dimensionattributevalueset] A LEFT JOIN [21D365_ods].[dimensionattributevalueset] B
		    ON A.[recid] = B.[recid]
		 WHERE B.[recid] IS NULL

		UPDATE A
		   SET A.[ODSRecordStatus] = 'C'
		  FROM [21D365_stg].[dimensionattributevalueset] A INNER JOIN [21D365_ods].[dimensionattributevalueset] B
		    ON A.[recid] = B.[recid]
	...
	*/
	...
	UPDATE A
	  ...
	  FROM [21D365_ods].[dimensionattributevalueset] A INNER JOIN [21D365_stg].[dimensionattributevalueset] B
	    ON A.[recid] = B.[recid]
