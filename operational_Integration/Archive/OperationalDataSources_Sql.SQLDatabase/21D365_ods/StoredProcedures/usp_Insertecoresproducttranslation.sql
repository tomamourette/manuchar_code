...
CREATE PROCEDURE [21D365_ods].[usp_Insertecoresproducttranslation]
...
BEGIN
	...
	*/
	...
	UPDATE A
	  ...
	  FROM [21D365_stg].[ecoresproducttranslation] A; 
	...
	*/
	...
	IF NOT EXISTS (SELECT count(*) FROM [21D365_ods].[ecoresproducttranslation] HAVING count(*) > 0)
	BEGIN
	    UPDATE [21D365_stg].[ecoresproducttranslation]
	...
	*/
	...
	IF EXISTS (SELECT count(*) FROM [21D365_ods].[ecoresproducttranslation] HAVING count(*) > 0)
	BEGIN

		UPDATE A
		   SET A.[ODSRecordStatus] = 'N'
		  FROM [21D365_stg].[ecoresproducttranslation] A LEFT JOIN [21D365_ods].[ecoresproducttranslation] B
		    ON A.[recid] = B.[recid]
		 WHERE B.[recid] IS NULL

		UPDATE A
		   SET A.[ODSRecordStatus] = 'C'
		  FROM [21D365_stg].[ecoresproducttranslation] A INNER JOIN [21D365_ods].[ecoresproducttranslation] B
		    ON A.[recid] = B.[recid]
	...
	*/
	...
	UPDATE A
	  ...
	  FROM [21D365_ods].[ecoresproducttranslation] A INNER JOIN [21D365_stg].[ecoresproducttranslation] B
	    ON A.[recid] = B.[recid]
	...
	*/
	...
	INSERT INTO [21D365_ods].[ecoresproducttranslation]			(			 [Id],			 [SinkCreatedOn],			 [SinkModifiedOn],			 [sysdatastatecode],			 [description],			 [languageid],			 [name],			 [product],			 [modifieddatetime],			 [modifiedby],			 [modifiedtransactionid],			 [createddatetime],			 [createdby],			 [createdtransactionid],			 [dataareaid],			 [recversion],			 [partition],			 [sysrowversion],			 [recid],			 [tableid],			 [versionnumber],			 [createdon],			 [modifiedon],			 [IsDelete],			 [PartitionId],			 [ODSStartDate],			 [ODSEndDate],			 [ODSActive],			 [ODSHashValue]			) 	  SELECT [Id],			 [SinkCreatedOn],			 [SinkModifiedOn],			 [sysdatastatecode],			 [description],			 [languageid],			 [name],			 [product],			 [modifieddatetime],			 [modifiedby],			 [modifiedtransactionid],			 [createddatetime],			 [createdby],			 [createdtransactionid],			 [dataareaid],			 [recversion],			 [partition],			 [sysrowversion],			 [recid],			 [tableid],			 [versionnumber],			 [createdon],			 [modifiedon],			 [IsDelete],			 [PartitionId],			 GETUTCDATE(),			 CONVERT(DATETIME, '31-12-9999', 103),			 CONVERT(BIT, 1),			 [ODSHashValue] 		FROM [21D365_stg].[ecoresproducttranslation] WHERE [ODSRecordStatus] IN ('C', 'N');					   
