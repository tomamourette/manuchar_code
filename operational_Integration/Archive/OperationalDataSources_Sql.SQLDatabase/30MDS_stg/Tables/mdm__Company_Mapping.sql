CREATE TABLE [30MDS_stg].[mdm__Company_Mapping] (
    [ID]                     INT            NULL,
    ...
    [MONA_Company_Code_Code] NVARCHAR (MAX) NULL,
    [MONA_Company_Code_Name] NVARCHAR (MAX) NULL,
    [MONA_Company_Code_ID]   INT            NULL,
