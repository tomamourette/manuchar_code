...
CREATE PROCEDURE [30MDS_ods].[usp_Insertmdm__Product_Grouping_Mapping]
...
BEGIN
	...
	*/
	...
	IF NOT EXISTS (SELECT count(*) FROM [30MDS_ods].[mdm__Product_Grouping_Mapping] HAVING count(*) > 0)
	BEGIN
	    UPDATE [30MDS_stg].[mdm__Product_Grouping_Mapping]
	...
	*/
	...
	IF EXISTS (SELECT count(*) FROM [30MDS_ods].[mdm__Product_Grouping_Mapping] HAVING count(*) > 0)
	BEGIN

		UPDATE A
		   SET A.[ODSRecordStatus] = 'N'
		  FROM [30MDS_stg].[mdm__Product_Grouping_Mapping] A LEFT JOIN [30MDS_ods].[mdm__Product_Grouping_Mapping] B
		    ON A.[ID] = B.[ID]
		 WHERE B.[ID] IS NULL

		UPDATE A
		   SET A.[ODSRecordStatus] = 'C'
		  FROM [30MDS_stg].[mdm__Product_Grouping_Mapping] A INNER JOIN [30MDS_ods].[mdm__Product_Grouping_Mapping] B
		    ON A.[ID] = B.[ID]
	...
	*/
	...
	UPDATE A
	  ...
	  FROM [30MDS_ods].[mdm__Product_Grouping_Mapping] A INNER JOIN [30MDS_stg].[mdm__Product_Grouping_Mapping] B
	    ON A.[ID] = B.[ID]
	...
	*/
	...
	SET @CommitCount = (SELECT COUNT(*) FROM [30MDS_stg].[mdm__Product_Grouping_Mapping])
	...
	*/
	...
	BEGIN
		BEGIN TRANSACTION
			INSERT INTO [30MDS_ods].[mdm__Product_Grouping_Mapping]					(					 [ID],					 [MUID],					 [Version_Name],					 [Version_Number],					 [Version_ID],					 [Version_Flag],					 [Name],					 [Code],					 [Change_Tracking_Mask],					 [Product_Grouping_Code_Code],					 [Product_Grouping_Code_Name],					 [Product_Grouping_Code_ID],					 [Product_Code_Code],					 [Product_Code_Name],					 [Product_Code_ID],					 [Default_Code],					 [Default_Name],					 [Default_ID],					 [Customer_Code],					 [Customer_Name],					 [Customer_ID],					 [Enter_DateTime],					 [Enter_User_Name],					 [Enter_Version_Number],					 [Last_Change_DateTime],					 [Last_Change_User_Name],					 [Last_Change_Version_Number],					 [Validation_Status],					 [ODSStartDate],					 [ODSEndDate],					 [ODSActive],					 [ODSHashValue]					) 			  SELECT [ID],					 [MUID],					 [Version_Name],					 [Version_Number],					 [Version_ID],					 [Version_Flag],					 [Name],					 [Code],					 [Change_Tracking_Mask],					 [Product_Grouping_Code_Code],					 [Product_Grouping_Code_Name],					 [Product_Grouping_Code_ID],					 [Product_Code_Code],					 [Product_Code_Name],					 [Product_Code_ID],					 [Default_Code],					 [Default_Name],					 [Default_ID],					 [Customer_Code],					 [Customer_Name],					 [Customer_ID],					 [Enter_DateTime],					 [Enter_User_Name],					 [Enter_Version_Number],					 [Last_Change_DateTime],					 [Last_Change_User_Name],					 [Last_Change_Version_Number],					 [Validation_Status],					 GETUTCDATE(),					 CONVERT(DATETIME, '31-12-9999', 103),					 CONVERT(BIT, 1),					 [ODSHashValue] 				FROM [30MDS_stg].[mdm__Product_Grouping_Mapping]			   WHERE [ODSRecordStatus] IN ('C', 'N');
